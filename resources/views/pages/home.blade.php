  ...
  <div class="container-site relative z-10">
    <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center py-20 md:py-28">
      ...
      <div class="animate-on-scroll">
        ...
        {{-- Stats row --}}
        <div class="flex items-center gap-3 sm:gap-6 mb-8">
          <div class="min-w-0">
            <p class="font-display font-bold text-xl sm:text-3xl text-white">50K+</p>
            <p class="text-navy-300 text-[10px] sm:text-sm">{{ __('home.stat_customers') }}</p>
          </div>
          <div class="w-px h-10 bg-navy-700 flex-shrink-0"></div>
          <div class="min-w-0">
            <p class="font-display font-bold text-xl sm:text-3xl text-white">4.8★</p>
            <p class="text-navy-300 text-[10px] sm:text-sm">{{ __('home.stat_rating') }}</p>
          </div>
          <div class="w-px h-10 bg-navy-700 flex-shrink-0"></div>
          <div class="min-w-0">
            <p class="font-display font-bold text-xl sm:text-3xl text-white">30</p>
            <p class="text-navy-300 text-[10px] sm:text-sm">{{ __('home.stat_guarantee') }}</p>
          </div>
        </div>
...
<section id="learn-more" class="section bg-white" aria-label="Why Dainely">
  <div class="container-site">
    <div class="text-left mb-16">
      ...
      <p class="text-lead max-w-2xl">{{ __('home.edu_subheadline') }}</p>
    </div>
