...
<section class="section bg-white">
  <div class="container-narrow">
    ...
    <div class="grid md:grid-cols-2 gap-6 mb-12">
      @foreach([
        [
          ...
          'detail' => 'We currently ship to all countries at no cost to you.',
          'color'  => 'sage',
    ...
    <div class="prose prose-slate max-w-none prose-a:text-blue-600 prose-a:underline hover:prose-a:text-blue-700">
      ...
      <p>If you've successfully placed an order and haven't received it yet but the tracking status shows it as delivered, please contact the carrier first to locate your package. Once the item is in the carrier's possession, we no longer have control over it. If the issue persists, contact us at <a href="mailto:contact@dainelylab.com">contact@dainelylab.com</a> and we will do our best to assist and resolve the issue as quickly as possible.</p>
      <p>Sometimes tracking information may not be available due to technical issues, preventing updates from showing on the app. If you're still unable to locate your item in this situation, please contact us at <a href="mailto:contact@dainelylab.com">contact@dainelylab.com</a> and we'll assist you at our earliest convenience.</p>
    ...
    <div class="mt-12 bg-navy-50 rounded-3xl p-6 md:p-8">
      ...
      <div class="grid sm:grid-cols-2 gap-5">
        @foreach([
          [
            'label' => 'Support Hours',
            'value' => 'Monday to Friday<br>9:00 – 18:00',
            'icon'  => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',
          ],
          [
            'label' => 'Phone',
            'value' => '<a href="tel:+18007211224" class="text-blue-600 underline hover:text-blue-700">+1 800 721 1224</a>',
            'icon'  => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',
          ],
          [
            'label' => 'Email',
            'value' => '<a href="mailto:contact@dainelylab.com" class="text-blue-600 underline hover:text-blue-700">contact@dainelylab.com</a>',
          ...
          [
            'label' => 'Address',
            'value' => '16192 Coastal Highway<br>County of Sussex, DE 19958',
            'icon'  => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0"/><circle cx="12" cy="10" r="3"/></svg>',
          ],
        ] as $info)
