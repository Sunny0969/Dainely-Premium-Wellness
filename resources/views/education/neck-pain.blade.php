  ...
  <div class="container-site grid lg:grid-cols-3 gap-12">
    ...
    <div class="space-y-6">
      ...
      <div class="card p-6 sticky top-24">
        ...
        <h3 class="font-semibold text-navy-900 text-lg mb-2">Address the Root Cause</h3>
        <p class="text-sm text-slate-600 mb-4">Restoring lumbar alignment often relieves cervical tension throughout the entire spinal chain.</p>
