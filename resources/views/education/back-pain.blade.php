...
@section('og_image', asset('images/back-pain-edu.png'))
  ...
  <div class="container-site relative z-10">
    <div class="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <div class="relative hidden lg:block">
        ...
        <img
          src="{{ asset('images/back-pain-edu.png') }}"
      ...
      <article class="prose prose-slate max-w-none" style="font-size:1rem;line-height:1.8">
        ...
        <div class="not-prose bg-navy-50 rounded-2xl p-6 my-8">
          <div class="flex gap-4">
            <img src="{{ asset('images/back-pain-edu.png') }}" alt="Back pain illustration" class="w-32 h-32 object-cover rounded-xl flex-shrink-0">
            <div>
...
<section class="section bg-gradient-to-br from-navy-900 to-navy-950 text-white" aria-label="Product CTA">
  <div class="container-narrow text-center">
    ...
    <p class="text-navy-400 text-sm mt-4">30-day guarantee · Free shipping over $75</p>
  </div>
</section>
