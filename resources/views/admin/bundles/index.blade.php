...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm h-fit">
        ...
        <form action="/admin/bundles" method="POST" class="space-y-4">
            @csrf
            <div>
        ...
        <div class="divide-y divide-slate-200">
            @forelse($bundles as $bundle)
                <div class="p-6 flex justify-between items-center gap-4">
                    ...
                    <div>
                        <a href="/admin/bundles/{{ $bundle->id }}/edit" class="bg-navy-600 hover:bg-navy-700 text-white text-xs font-bold px-3 py-2 rounded transition">
                            Edit Components
                        </a>
                    </div>
                </div>
