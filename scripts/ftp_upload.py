...
def main() -> int:
    ...
    uploads = [
        ...
        (ROOT / "public" / "build", "dainely.com/build"),
        ...
        (ROOT / "app" / "Http" / "Controllers" / "Admin", "app/Http/Controllers/Admin"),
        ...
        (ROOT / "app" / "Http" / "Middleware" / "TrustProxies.php", "app/Http/Middleware/TrustProxies.php"),
        (ROOT / "app" / "Http" / "Middleware" / "AdminAuth.php", "app/Http/Middleware/AdminAuth.php"),
        (ROOT / "app" / "Http" / "Middleware" / "TrackPageViews.php", "app/Http/Middleware/TrackPageViews.php"),
        (ROOT / "app" / "Http" / "Middleware" / "SetCloudflareCacheHeaders.php", "app/Http/Middleware/SetCloudflareCacheHeaders.php"),
        (ROOT / "app" / "Http" / "Kernel.php", "app/Http/Kernel.php"),
        (ROOT / "app" / "Http" / "Controllers" / "Admin" / "AdminProductController.php", "app/Http/Controllers/Admin/AdminProductController.php"),
        ...
        (ROOT / "app" / "Support" / "ProductLandingAssets.php", "app/Support/ProductLandingAssets.php"),
        ...
        (ROOT / "public" / "images", "dev.dainelylab.com/images"),
        (ROOT / "public" / "images", "public/images"),
        (ROOT / "public" / "images", "dainely.com/images"),
        ...
        (ROOT / "resources" / "views" / "admin", "resources/views/admin"),
