...
class EducationController extends Controller
{
    ...
    public function index(string $locale)
    {
        ...
        $groupedPages = Cache::remember("education_index_pages_v1_{$locale}", 3600, function() {
    ...
    {
        $page = EducationPage::where('slug', $slug)->where('is_active', true)->firstOrFail();
        ...
        return view('education.show', compact('locale', 'page', 'product', 'relatedLinks', 'breadcrumbs', 'pageBlocks', 'faqItems'));
    }
}
