...
class ProductLandingAssets
{
    ...
    public static function forProduct(
        ...
        $map = [
            ...
            'products_patches' => [
                // Order matches lifestyle_cards: Active Movement → At Your Desk → Travel
                'lifestyleImages' => ['lifestyle-everyday-movement.webp', 'back-pain-edu.webp', 'recovery-edu.webp'],
                'scienceImage'    => 'lifestyle-everyday-movement.webp',
            ],
            'products_jacket' => [
            ...
            'products_dmede' => [
                'lifestyleImages' => ['daily-relief-system.png', 'lifestyle-everyday-movement.webp', 'recovery-edu.webp'],
