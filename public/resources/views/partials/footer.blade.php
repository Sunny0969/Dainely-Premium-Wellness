  ...
  <div class="container-site py-16">
    ...
    <div class="flex flex-row flex-wrap md:flex-nowrap justify-between gap-6 lg:gap-12 items-start w-full">
      ...
      <div class="flex-1 w-full min-w-[250px] lg:flex-[1.2]">
        ...
        <form action="{{ route('newsletter.subscribe', ['locale' => app()->getLocale()]) }}" method="POST" class="relative flex items-center w-full mb-6">
          @csrf
          <input 
            type="email" 
            name="email" 
        ...
        @if(session('newsletter_success'))
          <p class="text-emerald-400 text-sm mb-4">{{ session('newsletter_success') }}</p>
        @endif
