...
<head>
  ...
  {{-- Preconnect + load fonts as link (do not @import fonts inside app.css) --}}
  ...
  <style>
    ...
    #site-header img[alt="Dainely"]{height:2.75rem;width:auto}
  </style>
...
{{-- GA4 client tag (browser). Server-side MP uses config/analytics.php + jobs. --}}
@if(config('analytics.ga4.measurement_id'))
