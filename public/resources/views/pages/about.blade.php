...
<section class="section bg-white text-center" aria-label="About CTA">
  <div class="container-narrow">
    ...
    <p class="text-slate-400 text-sm mt-4">30-day money-back guarantee · Free shipping over {{ app(\App\Services\CurrencyService::class)->formatForLocale(app(\App\Services\CurrencyService::class)->freeShippingThresholdUsd(), app()->getLocale()) }}</p>
  </div>
</section>
