...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    ,{
      "@type": "Product",
      "name": @json($schemaProduct['title']),
      "image": @json($schemaProduct['image'] ?? ''),
      "offers": {
        "@type": "Offer",
        "priceCurrency": "USD",
        "price": @json((string) ($schemaProduct['price'] ?? '0')),
...
@php
  ...
  $drsUrl      = !empty($dailyRelief['handle'])
    ...
    : route('products.index', ['locale' => $locale]);
  $beltImage   = $featuredBelt['image'] ?? null;
  $heroImage   = $beltImage ?: asset('images/hero-dainely-belt-lifestyle.png');
  ...
  $freeShipDisplay = app(\App\Services\CurrencyService::class)->formatForLocale(
...
<section class="section bg-white" aria-label="Lifestyle">
  <div class="container-site">
    ...
    <div class="grid md:grid-cols-3 gap-4 md:gap-6">
      @foreach([
        ['lifestyle-travel-commute-2.png', 'home.lifestyle_1'],
        ['lifestyle-everyday-movement.webp', 'home.lifestyle_2'],
