@extends('layouts.app')
@section('title', 'Privacy Policy | Dainely')
@section('meta_description', 'Dainely Privacy Policy — how we collect, use, and protect your personal data.')
@section('content')
<section class="bg-navy-900 text-white py-12">
  <div class="container-narrow text-center">
    <h1 class="font-display font-bold text-3xl text-white mb-2">Privacy Policy</h1>
    <p class="text-navy-300">Last updated: April 17, 2022</p>
  </div>
</section>
<section class="section bg-white">
  <div class="container-narrow prose prose-slate max-w-none prose-a:text-blue-600 prose-a:underline hover:prose-a:text-blue-700">
    ...
    <h2>Contact</h2>
    <p>After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by email at <a href="mailto:contact@dainely.com">contact@dainely.com</a>.</p>
    ...
    <ul>
      ...
      <li><strong>Source of collection:</strong> collected from you.</li>
      <li><strong>Disclosure for a business purpose:</strong> shared with our processor Shopify.</li>
      <li><strong>Personal Information collected:</strong> name, email address, order details, and any other information you choose to share with our support team.</li>
    </ul>

    <h2>Minors</h2>
    <p>The Site is not intended for individuals under the age of 16. We do not intentionally collect Personal Information from children. If you are the parent or guardian and believe your child has provided us with Personal Information, please contact us at the address above to request deletion.</p>
    ...
    <p>We <strong>do not</strong> engage in fully automated decision-making that has a legal or otherwise significant effect using customer data.</p>
    <p>Our processor Shopify uses limited automated decision-making to prevent fraud that does not have a legal or otherwise significant effect on you. Services that include elements of automated decision-making include:</p>
    <ul>
    ...
    <p>Our Site sells Personal Information, as defined by the California Consumer Privacy Act of 2018 ("CCPA"). To opt out of the sale of your Personal Information, or to learn more about the categories of information we may sell, please contact us at <a href="mailto:contact@dainely.com">contact@dainely.com</a>. We do not knowingly sell the Personal Information of minors under 16 years of age.</p>
    ...
    <div class="not-prose overflow-x-auto rounded-2xl border border-slate-200 my-6">
      <table class="w-full text-sm">
        <thead class="bg-navy-50">
          <tr>
            <th class="text-left font-display font-bold text-navy-900 px-4 py-3 border-b border-slate-200">Name</th>
            <th class="text-left font-display font-bold text-navy-900 px-4 py-3 border-b border-slate-200">Function</th>
            <th class="text-left font-display font-bold text-navy-900 px-4 py-3 border-b border-slate-200 whitespace-nowrap">Duration</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-slate-200">
          @foreach([
            ...
            ['shopify_pay_redirect', 'Used in connection with checkout.', '30min, 3w or 1y depending on value'],
          ...
          ] as [$name, $function, $duration])
          <tr class="hover:bg-slate-50">
            <td class="px-4 py-3 font-mono text-navy-900 whitespace-nowrap">{{ $name }}</td>
            <td class="px-4 py-3 text-slate-600">{{ $function }}</td>
            <td class="px-4 py-3 text-slate-500 whitespace-nowrap">{{ $duration }}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
    ...
    <p>Most browsers automatically accept cookies, but you can choose whether or not to accept cookies through your browser controls, often found in your browser's "Tools" or "Preferences" menu. For more information on how to modify your browser settings or how to block, manage or filter cookies, see your browser's help file or visit a site such as <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer">www.allaboutcookies.org</a>.</p>
    ...
    <h2>Complaints</h2>
    <p>As noted above, if you would like to make a complaint, please contact us by email at <a href="mailto:contact@dainely.com">contact@dainely.com</a>. If you are not satisfied with our response to your complaint, you have the right to lodge your complaint with the relevant data protection authority in your jurisdiction.</p>

    <p class="text-sm text-slate-500 mt-10 pt-6 border-t border-slate-200"><strong>Last updated:</strong> 17 April 2022</p>
