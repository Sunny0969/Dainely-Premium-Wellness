...
class FaqSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $faqs = [
            ...
            ['category'=>'returns','q_en'=>'How do I start a return?','a_en'=>'Email contact@dainelylab.com with your order number and reason (optional). We will send a prepaid return label within 24 hours and process your refund within 3–5 business days of receiving the item.','q_fr'=>'Comment initier un retour?','a_fr'=>'Envoyez un email à contact@dainelylab.com avec votre numéro de commande. Nous enverrons une étiquette de retour prépayée sous 24 heures.','q_de'=>'Wie starte ich eine Rücksendung?','a_de'=>'Senden Sie eine E-Mail an contact@dainelylab.com mit Ihrer Bestellnummer. Wir senden innerhalb von 24 Stunden ein Rücksendelabel.'],
        ];
